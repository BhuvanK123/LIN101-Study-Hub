...
#ifndef LIN101_PREP_SWIFT_H
#define LIN101_PREP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="lin101_prep",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC11lin101_prep11AppDelegate")
...
SWIFT_CLASS("_TtC11lin101_prep17MainFlutterWindow")
